...
local button_remote=""
if running then
	button_margin="<div style=\"height:18px\"></div>"
	button="<input class=\"cbi-button cbi-button-link\" type=\"button\" value=\" " .. translate("Open Web Interface") .. " (Local)" .. " \" onclick=\"window.open(window.location.protocol+'//'+window.location.host+'/aria2')\"/>"
	button_remote="<input class=\"cbi-button cbi-button-link\" type=\"button\" value=\" " .. translate("Open Web Interface") .. " (Latest)" .. " \" onclick=\"window.open('http://ziahamza.github.io/webui-aria2')\"/>"
end

m=Map("aria2",translate("Aria2 Downloader"),translate("Use this page, you can download files from HTTP FTP and BitTorrent via Aria2.") .. button_margin .. button .. "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" .. button_remote)
...
cmd_line=advanced:option(Value,"cmd_line",translate("Command-Lines"),translate("To check all commands availabled, visit:") .. "&nbsp;<a onclick=\"window.open('http://aria2.sourceforge.net/manual/en/html/index.html')\" style=\"cursor:pointer\"><font color='blue'><i><u>http://aria2.sourceforge.net/manual/en/html/index.html</u></i></font></a>")
