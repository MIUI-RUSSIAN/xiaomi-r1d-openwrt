(function($){
    var _isIE6 = !!($.browser.msie && $.browser.version == '6.0'),
        ...
        defaults = {
            // 消息内容
            content: '<div class="d-loading"><span>'+ i18n.dialog.loading +'</span></div>',
            // 标题
            title: i18n.dialog.dlgtitle,
            // 自定义按钮
            button: null,
            // 确定按钮回调函数
            ok: null,
            ...
            beforeunload: null,
            // 确定按钮文本
            okValue: i18n.dialog.ok,
            // 取消按钮文本
            cancelValue: i18n.dialog.cancel,
            // 内容宽度
            width: '600',
            // 内容高度
            height: 'auto',
        ...
        tplMask = '<div class="panel-mask" style="position:fixed;left:0;top:0;style:none;"><iframe style="width:100%;height:100%;filter:alpha(opacity=0);"></iframe></div>',
        tplDialog = ''
+'<div class="panel panel-dialog" style="position:fixed;left:0;top:0;style:none;">'
    ...
    Dialog.prototype = {
        ...
        button: function(){
            ...
            for (var i = 0; i < btns.length; i++) {
                ...
                if ( isNewBtn ) {
                    ...
                    button = $('<a href="#" data-id="'+ id +'" class="btn '+ dft +'"><span>'+ value +'</span></a>');
                    ...
                    if (btn.disabled) {
                        ...
                        button.removeClass(dft).addClass('btn-disabeld')
                    }
                    if (btn.focus) {
                        button.removeClass(dft).addClass(primary);
                    }
                    ft.append(button);
                }
            }
        ...
        _addEvent : function(){
            ...
            dom['close'].on('click', function(e){
                //直接remove弹窗DOM，在ie下未能冒泡到document的click事件，添加setTimeout解决
                setTimeout(function(){
                    that.close();
                }, 0);
            });
